...
const I18N_TEXTS = {
  th: {
    ...
    faq_q4_desc: "สำหรับผู้ประกอบการที่เปิดร้านกาแฟ หรือกำลังจะเปิดร้าน สามารถแอด LINE หรือโทรติดต่อ <strong>คุณปิ่นปัก (098-603-5370)</strong> เซลล์ผู้ดูแลประจำแบรนด์ MATCHA TIMES ได้โดยตรง เพื่อแจ้งขอรับชุด <strong>Matcha Times Sample Kit</strong> สำหรับทดลองชงจริงที่ร้าน เซลล์พร้อมให้คำแนะนำเรื่องอัตราส่วนและจัดทำใบเสนอราคาส่ง B2B ให้ทันที",

    // Sample Kit Banner
    banner_badge: "✦ B2B Cafe Partnership",
    banner_title: "เปิดร้านกาแฟ หรือต้องการยกระดับเมนูมัทฉะ?",
    banner_desc: "ขอรับชุด <strong>Matcha Times Sample Kit</strong> สำหรับทดลองชงจริงที่ร้าน พร้อมรับคำปรึกษาเรื่องอัตราส่วนและคำนวณต้นทุนต่อแก้วฟรีจากคุณปิ่นปัก (ฝ่ายขาย)",
    ...
    contact_modal_sub: "ที่ปรึกษาด้านมัทฉะสำหรับร้านคาเฟ่ ยินดีให้คำแนะนำเรื่องสเปกชา ราคาส่ง B2B และจัดส่ง Sample Kit",
    contact_qr_text: "สแกน QR Code เพื่อคุยกับคุณปิ่นปักทาง LINE",
    contact_tip_box: "<strong>สำหรับร้านเปิดใหม่:</strong> ทักหาคุณปิ่นปักว่า <em>&ldquo;ขอรับชุด Sample Kit ทดลองชงที่ร้าน&rdquo;</em> เพื่อรับตัวอย่างชาและคำแนะนำอัตราส่วนสูตรชงเฉพาะร้านคุณ",
  ...
  en: {
    ...
    hero_ai_title: "Nong Matcha AI Sommelier",
