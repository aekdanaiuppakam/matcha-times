...
const I18N_TEXTS = {
  th: {
    ...
    hero_cta_line: "ติดต่อคุณปิ่นปักทาง LINE",
    hero_cta_sample: "ขอรับชุดทดลองชง",
    hero_ai_title: "MATTY (แมตตี้) AI Sommelier",
    hero_ai_badge: "ถามได้ 24 ชม.",
    hero_ai_sub: "💡 สงสัยเรื่องเกรดชา, โทนรสชาติ, คุมต้นทุนต่อแก้ว หรือสูตรชง แตะลองถามได้ทันทีครับ:",
    hero_ai_cta: "เปิดแชทคุย",
    hero_cta_matchmaker: "ช่วยเลือกมัทฉะให้ร้านคุณ",
    ...
    stat_direct_sub: "นำเข้าตรง โม่หินแท้จากญี่ปุ่น",
    stat_margin: "กำไรเฉพาะผงชา สูงสุด 80%+",
    stat_margin_sub: "ต้นทุนผงชาเริ่มต้นเพียง ~12.8 ฿/แก้ว",
    ...
    pillar_1_desc: "วัตถุดิบมัทฉะแท้ 100% จากสวนในญี่ปุ่น ไม่ผสมแป้ง ไม่แต่งสีสังเคราะห์ คงคุณค่าสารต้านอนุมูลอิสระ (Catechins) และ L-Theanine ตามธรรมชาติของใบชา",
    ...
    pillar_3_desc: "มัทฉะมอบความรู้สึก Calm Alert ให้พลังงานนุ่มนวลผ่อนคลายด้วยคุณสมบัติของ L-Theanine ช่วยสร้างความสดชื่นและสมาธิในชีวิตประจำวัน",
    ...
    catalog_subheading: "เรียงจากเกรดพิธีการ (Ceremonial) ลงมาสู่เกรดยาเมะ ซิกเนเจอร์ และคลาสสิกคอมเมอร์เชียล",
    ...
    btn_copy_line: "คัดลอกสรุปสเปกส่งให้เซลล์ทาง LINE",
    ...
    calc_other_cost_label: "ต้นทุนอื่นต่อแก้ว (นม/แก้ว/น้ำแข็ง)",
    ...
    calc_notice: "<strong>⚠️ หมายเหตุ:</strong> การคิด Margin ทั่วไปจะหักเฉพาะ <em>\"ต้นทุนผงชา\"</em> (ยังไม่รวมนม น้ำเชื่อม แก้ว ฝา น้ำแข็ง ค่าแรง และค่าใช้จ่ายร้าน) คุณสามารถปรับสไลเดอร์ <strong>\"ต้นทุนอื่นต่อแก้ว\"</strong> ด้านบน เพื่อดูผลกำไรสุทธิจริงได้ทันที",
    calc_tip: "<strong>💡 แนะนำสำหรับคาเฟ่:</strong> ใช้ <strong>Strong Nutty</strong> หรือ <strong>Yurane</strong> เป็นตัวหลักหน้าร้าน ต้นทุนผงชาเพียง ~18-21 ฿/แก้ว ขายที่ 85-95 ฿ กำไรขั้นต้นหลังหักเฉพาะต้นทุนผงชา สูงสุด 75-80%+ และเสริมด้วย <strong>Shoen</strong> หรือ <strong>Yame B</strong> เป็นซิกเนเจอร์พรีเมียม",
    ...
    faq_q4_title: "ราคาส่งคาเฟ่ & การขอชุดทดลองชง?",
    faq_q4_desc: "สำหรับผู้ประกอบการที่เปิดร้านกาแฟ หรือกำลังจะเปิดร้าน สามารถแอด LINE หรือโทรติดต่อ <strong>คุณปิ่นปัก (098-603-5370)</strong> เซลล์ผู้ดูแลประจำแบรนด์ MATCHA TIMES ได้โดยตรง เพื่อแจ้งขอรับ <strong>ชุดทดลอง Matcha Times</strong> สำหรับทดลองชงจริงที่ร้าน เซลล์พร้อมให้คำแนะนำเรื่องอัตราส่วนและจัดทำใบเสนอราคาส่ง B2B ให้ทันที",

    // Sample Kit Banner
    banner_badge: "✦ B2B Cafe Partnership",
    banner_title: "เปิดร้านกาแฟ หรือต้องการยกระดับเมนูมัทฉะ?",
    banner_desc: "ขอรับ <strong>ชุดทดลอง Matcha Times</strong> สำหรับทดลองชงจริงที่ร้าน พร้อมรับคำปรึกษาเรื่องอัตราส่วนและคำนวณต้นทุนต่อแก้วฟรีจากคุณปิ่นปัก (ฝ่ายขาย)",
    banner_btn_kit: "ขอรับชุดทดลอง",
    banner_btn_line: "ทัก LINE คุณปิ่นปัก",
    banner_btn_flyer: "ดูใบราคาเต็ม",

    // Modals & Floating
    flyer_modal_title: "ใบแคตตาล็อกต้นฉบับ MATCHA TIMES",
    contact_modal_title: "ติดต่อฝ่ายขาย: คุณปิ่นปัก (MATCHA TIMES)",
    contact_modal_sub: "ที่ปรึกษาด้านมัทฉะสำหรับร้านคาเฟ่ ยินดีให้คำแนะนำเรื่องสเปกชา ราคาส่ง B2B และจัดส่งชุดทดลอง",
    contact_qr_text: "สแกน QR Code เพื่อคุยกับคุณปิ่นปักทาง LINE",
    contact_tip_box: "<strong>สำหรับร้านเปิดใหม่:</strong> ทักหาคุณปิ่นปักว่า <em>&ldquo;ขอรับชุดทดลองเพื่อทดลองชงที่ร้าน&rdquo;</em> เพื่อรับตัวอย่างชาและคำแนะนำอัตราส่วนสูตรชงเฉพาะร้านคุณ",
    contact_btn_line: "แอด LINE คุยกับคุณปิ่นปัก",
    contact_btn_phone: "โทรด่วน: 098-603-5370 (คุณปิ่นปัก)",
    contact_btn_ig: "ติดตาม Instagram: @matchatimes.thailand",
    contact_rep: "👩‍💼 <strong>เซลล์ผู้ดูแล:</strong> คุณปิ่นปัก · ",
    contact_branches: "📍 <strong>สาขาแบรนด์:</strong> Silom, Asok (Interchange 21), Phrakanong",
    fab_ai: "🍵 คุยกับ AI มัทฉะ",
    fab_line: "ทัก LINE คุณปิ่นปัก",
    toast_copied: "คัดลอกสรุปสเปกส่งให้เซลล์ทาง LINE แล้ว!",

    // AI Chat Modal & Floating Teaser
    ai_teaser_title: "มีคำถามเรื่องชา?",
    ai_teaser_sub: "แตะถาม MATTY (แมตตี้) AI ได้เลยครับ 🐼🍵",
    ai_chat_name: "MATTY (แมตตี้)",
    ai_chat_status: "มาสคอตที่ปรึกษามัทฉะ · ออนไลน์ 🐼",
    ai_welcome_greeting: "สวัสดีครับพี่เจ้าของร้านคาเฟ่!",
    ai_welcome_p1: "ผมคือ <strong>MATTY (แมตตี้)</strong> มาสคอต AI Matcha Sommelier ประจำ <strong>MATCHA TIMES</strong> ครับ 🐼🍵",
    ai_welcome_p2: "สงสัยเรื่องการเลือกเกรดชา, โทนรสชาติ, การคุมต้นทุนต่อแก้ว, หรือสูตรชงลาเต้/เดอร์ตี้ ลองถามผมได้เลยครับ!",
    ai_quick_label: "คำถามยอดฮิตสำหรับคาเฟ่:",
    ai_input_placeholder: "พิมพ์ถาม MATTY ได้เลยครับ...",
    ai_footer_notice: "ตอบโดย Gemini AI อ้างอิงข้อมูลสต็อกและสเปกจริง MATCHA TIMES",
    ...
    footer_contact: "ติดต่อเซลล์ฝ่ายขาย",
  ...
  en: {
    ...
    hero_cta_line: "Contact Pinpuk via LINE",
    hero_cta_sample: "Request Sample Kit",
    hero_cta_matchmaker: "Find Matcha for Your Cafe",
    hero_ai_title: "MATTY AI Sommelier",
    hero_ai_badge: "Ask 24/7",
    hero_ai_sub: "💡 Inquire about grades, flavor profiles, cup costing, or cafe recipes:",
    hero_ai_cta: "Open Chat",
    stat_skus: "10 Selected SKUs",
    stat_skus_sub: "Ceremonial to Commercial",
    stat_regions: "4 Renowned Terroirs",
    stat_regions_sub: "Nishio, Uji, Yame, Shizuoka",
    stat_direct: "100% Direct Import",
    stat_direct_sub: "Imported Directly from Japan, Stone-Milled",
    stat_margin: "Tea Powder Margin up to 80%+",
    ...
    pillar_1_title: "Authenticity",
    pillar_1_desc: "100% pure Japanese tea with zero fillers or artificial coloring, preserving natural antioxidants (Catechins) and calm-focus L-Theanine.",
    pillar_2_title: "Accessibility",
    ...
    pillar_3_title: "Everyday Joy",
    pillar_3_desc: "Matcha provides smooth, calm-alert focus supported by natural L-Theanine, turning every cup into an uplifting daily ritual.",
    ...
    btn_copy_line: "Copy Spec for Sales Rep via LINE",
    ...
    calc_other_cost_label: "Other Cost / Cup (Milk/Cup/Ice)",
    ...
    calc_col_margin: "Margin",
    calc_notice: "<strong>⚠️ Note:</strong> Standard margin calculations deduct <em>tea powder cost only</em> (excluding milk, syrup, cup, lid, ice, and labor). Adjust the <strong>\"Other Cost / Cup\"</strong> slider above to calculate your store's true net profit.",
    calc_tip: "<strong>💡 Recommendation for Cafes:</strong> Use <strong>Strong Nutty</strong> or <strong>Yurane</strong> as your primary house latte offering (~18-21 THB powder cost). Selling at 85-95 THB achieves tea powder gross margin up to 75-80%+. Pair with <strong>Shoen</strong> or <strong>Yame B</strong> for high-ticket signature specials.",
    ...
    faq_q4_desc: "Cafe owners and beverage developers can connect directly with <strong>Pinpuk (098-603-5370)</strong>, our dedicated MATCHA TIMES sales representative, via LINE to request our comprehensive <strong>Matcha Times Sample Kit</strong> for on-site test brewing, complete with recipe ratio sheets.",

    // Sample Kit Banner
    banner_badge: "✦ B2B Cafe Partnership",
    banner_title: "Opening a Cafe or Upgrading Your Matcha Menu?",
    banner_desc: "Request a <strong>Matcha Times Sample Kit</strong> for test brewing at your bar, paired with complimentary recipe consulting and margin analysis from Pinpuk (Sales Representative).",
    banner_btn_kit: "Request Sample Kit",
    banner_btn_line: "Message Pinpuk on LINE",
    banner_btn_flyer: "View Full Price List",

    // Modals & Floating
    flyer_modal_title: "MATCHA TIMES Original Wholesale Price List",
    contact_modal_title: "Contact Sales: Pinpuk (MATCHA TIMES)",
    contact_modal_sub: "Dedicated Matcha Consultant for cafes — B2B wholesale pricing, custom quotations, and Sample Kit requests.",
    contact_qr_text: "Scan QR Code to chat with Pinpuk on LINE",
    contact_tip_box: "<strong>For New Cafe Openings:</strong> Message Pinpuk <em>\"Requesting Sample Kit for Cafe Tasting\"</em> to receive complimentary samples and ratio guides.",
    contact_btn_line: "Add LINE: Chat with Pinpuk",
    contact_btn_phone: "Call: 098-603-5370 (Pinpuk)",
    contact_btn_ig: "Follow Instagram: @matchatimes.thailand",
    contact_rep: "👩‍💼 <strong>Sales Consultant:</strong> Pinpuk · ",
    contact_branches: "📍 <strong>Brand Branches:</strong> Silom, Asok (Interchange 21), Phrakanong",
    fab_ai: "🍵 AI Matcha Sommelier",
    fab_line: "Chat with Pinpuk",
    toast_copied: "Spec copied for Pinpuk on LINE!",

    // AI Chat Modal & Floating Teaser
    ai_teaser_title: "Have tea questions?",
    ai_teaser_sub: "Tap to ask MATTY AI sommelier 🐼🍵",
    ai_chat_name: "MATTY",
    ai_chat_status: "Matcha Sommelier Mascot · Online 🐼",
    ai_welcome_greeting: "Hello, Cafe Owner! 👋",
    ai_welcome_p1: "I'm <strong>MATTY</strong>, your AI Matcha Sommelier mascot from <strong>MATCHA TIMES</strong> 🐼🍵",
    ai_welcome_p2: "Inquiring about tea grades, flavor notes, cost-per-cup control, or latte/dirty recipe ratios? Ask me anytime!",
    ai_quick_label: "Popular questions for cafes:",
    ai_input_placeholder: "Ask MATTY anything about matcha...",
    ai_footer_notice: "Powered by Gemini AI · Based on verified MATCHA TIMES specs",
    ...
    footer_contact: "Contact Sales Rep",
